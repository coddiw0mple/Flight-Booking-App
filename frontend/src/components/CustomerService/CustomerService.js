            ...
            <div className="row">
                ...
                <div className="column3" >
                    ...
                    <br/><br/>
                        ...
                        <center>
                            <br/>
                        <p class="te">EMAIL: divithphogatgp@gmail.com</p>
                    <p class="te">CONTACT NUMBER: 9372846149</p>
                    <p class="te">ADDRESS:Amrita Vishwa Vidyapeetham, Coimbatore </p>
                    </center>
                        </center>
                        <br/><br/>
                        <p className='bo'>If you need any information send mail</p>

        <a href="mailto:divithphogatgp@gmail.com" className='bo'>Report via mail</a><br></br>
